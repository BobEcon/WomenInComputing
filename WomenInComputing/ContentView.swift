...
//  WomenInComputing
//
//  Created by Robert Beachill on 03/03/2025.
// The commented code is stuff I put in which works but is not strictly necessary
...
struct ContentView: View {
    ...
    private let names: [String] = ["Ada Lovelace",
...
//                    currentIndex -= 1
//                    currentIndex = (currentIndex < 0) ? names.count - 1 : currentIndex
                    updateView()
                } label: {
...
//                    .frame(height: 50)
                ...
                Button {
                    currentIndex += 1
                    currentIndex = (currentIndex < names.count) ? currentIndex : 0
                    updateView()
                } label: {
...
//                    .font(.body)
            ...
            HStack {
                ...
                Button {
                    var num1 = Int.random(in: 0..<names.count)
                    while num1 == currentIndex {
                        num1 = Int.random(in: 0..<names.count)
                    }
                    currentIndex = num1
                    updateView()
        ...
        .onAppear {
            ...
            currentImage = names[currentIndex]
            currentBio = bios[currentIndex]
        }
    }
